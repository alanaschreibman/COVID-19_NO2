...
libraries("rgdal", "gdalUtils", "raster", "maptools", "ggplot2", "cowplot", "dplyr", "sp", "sf", "rgdal", "stringr", "RColorBrewer", "ggcorrplot", "pander", "forcats", "ggsn")
```
...
`South Sudan.shp` <- `Sudan.shp`
  `South Sudan.shp`$NAME <- as.character(`South Sudan.shp`$NAME) 
  `South Sudan.shp`@data[1,5] <- sub("Sudan", "South Sudan",`South Sudan.shp`@data[1,5])
  rm(Sudan.shp)
...
#Merged geospatial data set with COVID data (variables come from COVID exploratory analysis RMD file). 
covid.NO2.df <- full_join(IHME.regions.df, owid.countries, by = "location")
