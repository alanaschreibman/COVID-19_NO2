...
#Cases
ggplot(mean.newcases.df, aes(x = Date, y = Mean_Weekly_Count)) +
  geom_line(size = 0.75) + 
...
#Deaths
ggplot(mean.newdeaths.df , aes(x = Date, y = Mean_Weekly_Count)) +
  geom_line(size = 0.75) + 
  theme(legend.key.size = unit(1, 'cm'),
        legend.title = element_text(size=14),
        legend.text = element_text(size=10),
...
ylim(0, 1.5E4) +
  ...
  geom_text(data=mean.newdeaths.df,aes(x=as.Date("2020-01-08"),y=1.475E4),label="Pre-Lockdown",color = "black", size = 1.5) +
  ...
  geom_text(data=mean.newdeaths.df,aes(x=as.Date("2020-04-01"),y=1.475E4),label="Lockdown 1", color = "black", size = 1.5) +
  ...
  geom_text(data=mean.newdeaths.df,aes(x=as.Date("2020-09-15"),y=1.475E4),label="Re-Opening", color = "black", size = 1.5) +
  theme_bw() + 
  scale_alpha_manual(values = c(0.4, 1.1)) + 
  scale_color_manual(values = c("gray", "blue", "black")) +
...
total.weekly.df <- urban.weekly.df %>% left_join(covid.weekly.df, by = "Week")
```
