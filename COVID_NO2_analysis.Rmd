...
US_NO2_change <- function(x) {
  r.vals <- raster::extract(paste0("./US_NO2_Comparison/", (x)), us.shp)
  lapply(r.vals, FUN=mean, na.rm = TRUE)
}
US_NO2_change("US_NO2_2019-01-19_start.tif")

US_NO2_change <- function(x, y) {
  ...
  boxplot(s, col=c('red', 'blue'), main='NO2 Before and After COVID-19', ylab='Date' )
}
US_NO2_change("US_NO2_2019-01-19_start.tif", "US_NO2_2019-03-19_start.tif")
...
US_NO2_change <- function(x, y) {
  ...
  mask(r2, us.shp)
  s <- stack(r1, r2)
  names(s) <- c('2020Jan-Mar', '2020Mar-May')
  boxplot(s, col=c('red', 'blue'), main='NO2 Before and After COVID-19', ylab='Date' )
}
US_NO2_change("US_NO2_2020-01-19_start.tif", "US_NO2_2020-03-19_start.tif")
...
US_NO2_change("US_NO2_2021-01-19_start.tif", "US_NO2_2021-03-19_start.tif")


US_NO2_change <- function(x) {
  r <- raster(paste0("./US_NO2_Comparison/", (x))) %>% flip(direction='y')
  r <- crop(r, extent(us.shp))
  mask(r, us.shp)
}

x <- US_NO2_change("US_NO2_2019-01-19_start.tif")
boxplot(x)
