...
#uruguay 2020-03-13 (not entirely clear, but closest estimate)
...
china <- "China"
top.10.countries <- c(top.10.countries, china) #Top 10 countries plus China. 
...
top.10.urban.fxn <- function(location) {
  ...
  country.shp <- spTransform(country.shp, CRSobj = "+init=epsg:4326 +proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
#China 2020 rural
country.sf <- rep(top.10.rural.shp.list[[1]], length.out = length(top.10.2020.raster.list[[11]]))
