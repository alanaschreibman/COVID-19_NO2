...
filter<-ee$Filter$intersects(leftField='.geo', rightField= '.geo', maxError=10)
join<-ee$Join$saveAll('NO2_concentration')
joinCol<-ee$ImageCollection(join$apply(NO2, pop, filter))
Map$addLayer(joinCol)
```
