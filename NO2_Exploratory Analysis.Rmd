...
#DELETE LATER (old dates going by weekly rather than weekly on every day for versatility)
...
#Use for now, delete later 
d <- seq(as.Date("2019-10-13"), as.Date("2019-10-30"), by=1)  

d1 <- seq(as.Date("2019-10-31"), as.Date("2020-02-28"), by=1)  
d2 <-  seq(as.Date("2020-03-01"), as.Date("2020-12-31"), by=1)
dd <- c(d1, d2)
dd <- dd[-(seq(1, 427, 7))]
dates.2020 <- c(d, dd)
