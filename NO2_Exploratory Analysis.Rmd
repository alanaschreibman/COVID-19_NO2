...
#Czechia
dates.2019 <- seq(as.Date("2018-12-01"), as.Date("2020-01-03"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), 12, 48, 19, 52, "Czechia")
}
d1 <- seq(as.Date("2019-12-01"), as.Date("2020-02-22"), by=7) #List of dates starting Dec 2 2019. 
...
dates.2019 <- seq(as.Date("2018-12-01"), as.Date("2020-01-03"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), 13, 45, 17, 47, "Slovenia")
}
d1 <- seq(as.Date("2019-12-01"), as.Date("2020-02-22"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-23"), as.Date("2020-03-01"), by=8) 
d3 <- seq(as.Date("2020-03-02"), as.Date("2021-01-03"), by=7) 
dates.2020 <- c(d1, d2, d3)
for (i in 1:length(dates.2020)) {
  countries.NO2.fxn(as.character(as.Date(dates.2020[[i]])), as.character(as.Date(dates.2020[[i]]) + 6), 13, 45, 17, 47, "Slovenia")
}
#Sweden
dates.2019 <- seq(as.Date("2018-12-01"), as.Date("2020-01-03"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
...
#Uruguay
dates.2019 <- seq(as.Date("2018-11-28"), as.Date("2019-12-31"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), -59, -35, -53, -30, "Uruguay")
}
d1 <- seq(as.Date("2019-11-28"), as.Date("2020-02-26"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-27"), as.Date("2020-03-05"), by=8) 
d3 <- seq(as.Date("2020-03-06"), as.Date("2020-12-31"), by=7) 
dates.2020 <- c(d1, d2, d3)
for (i in 1:length(dates.2020)) {
  countries.NO2.fxn(as.character(as.Date(dates.2020[[i]])), as.character(as.Date(dates.2020[[i]]) + 6), -59, -35, -53, -30, "Uruguay")
}
#Lithuania
dates.2019 <- seq(as.Date("2018-12-01"), as.Date("2020-01-03"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
...
#United States
dates.2019 <- seq(as.Date("2018-12-04"), as.Date("2020-01-06"), by=7) #List of dates starting Dec 3 2018.
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), -130, 23, -65, 49, "US")
}
d1 <- seq(as.Date("2019-12-04"), as.Date("2020-02-25"), by=7) #List of dates starting Dec 2 2019. 
...
#Netherlands
dates.2019 <- seq(as.Date("2018-11-30"), as.Date("2020-01-02"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), 3, 50, 8, 54, "Netherlands")
}
d1 <- seq(as.Date("2019-11-30"), as.Date("2020-02-21"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-22"), as.Date("2020-02-29"), by=8) 
d3 <- seq(as.Date("2020-03-01"), as.Date("2021-01-02"), by=7) 
dates.2020 <- c(d1, d2, d3)
for (i in 1:length(dates.2020)) {
  countries.NO2.fxn(as.character(as.Date(dates.2020[[i]])), as.character(as.Date(dates.2020[[i]]) + 6), 3, 50, 8, 54, "Netherlands")
}
#Estonia
dates.2019 <- seq(as.Date("2018-11-28"), as.Date("2019-12-31"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), 21, 57, 29, 60, "Estonia")
}
d1 <- seq(as.Date("2019-11-28"), as.Date("2020-02-26"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-27"), as.Date("2020-03-05"), by=8) 
d3 <- seq(as.Date("2020-03-06"), as.Date("2020-12-31"), by=7) 
dates.2020 <- c(d1, d2, d3)
for (i in 1:length(dates.2020)) {
  countries.NO2.fxn(as.character(as.Date(dates.2020[[i]])), as.character(as.Date(dates.2020[[i]]) + 6), 21, 57, 29, 60, "Estonia")
}
#Argentina
dates.2019 <- seq(as.Date("2018-12-05"), as.Date("2020-01-07"), by=7) #List of dates starting Dec 3 2018.
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), -74, -56, -53, -20, "Argentina")
}
d1 <- seq(as.Date("2019-12-05"), as.Date("2020-02-26"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-27"), as.Date("2020-03-05"), by=8) 
...
dates.2019 <- seq(as.Date("2018-12-04"), as.Date("2020-01-06"), by=7) #List of dates starting Dec 3 2018.
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), 34, 29, 36, 34, "Israel")
}
d1 <- seq(as.Date("2019-12-04"), as.Date("2020-02-25"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-26"), as.Date("2020-03-04"), by=8) 
d3 <- seq(as.Date("2020-03-05"), as.Date("2021-01-06"), by=7) 
dates.2020 <- c(d1, d2, d3)
for (i in 1:length(dates.2020)) {
  countries.NO2.fxn(as.character(as.Date(dates.2020[[i]])), as.character(as.Date(dates.2020[[i]]) + 6), 34, 29, 36, 34, "Israel")
}
#China
dates.2019 <- seq(as.Date("2018-10-31"), as.Date("2019-10-29"), by=7) #List of dates starting Dec 3 2018. 
for (i in 1:length(dates.2019)) {
  countries.NO2.fxn(as.character(as.Date(dates.2019[[i]])), as.character(as.Date(dates.2019[[i]]) + 6), 72, 17, 136, 54, "China")
}
d1 <- seq(as.Date("2019-10-31"), as.Date("2020-02-26"), by=7) #List of dates starting Dec 2 2019. 
d2 <- seq(as.Date("2020-02-27"), as.Date("2020-03-05"), by=8) 
