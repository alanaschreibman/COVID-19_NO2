...
countries.NO2.fxn <- function(minx, miny, maxx, maxy, country) {
  image1 <- ee$ImageCollection("COPERNICUS/S5P/NRTI/L3_NO2")$filterDate('2018-07-10', '2019-07-10')$select("tropospheric_NO2_column_number_density") %>% ee$ImageCollection$mean()
  geometry <- ee$Geometry$Rectangle(
...
#Weeks defined Mondays-Sun6days starting on Dec 31st 2018. 
